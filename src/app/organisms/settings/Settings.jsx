  ...
  return (
    <div className="settings-appearance">
      <div className="settings-appearance__card">
        <MenuHeader>{t('Organisms.Settings.theme.theme_title')}</MenuHeader>
        <SettingTile
        ...
        />
        <SettingTile
          title={t('Organisms.Settings.theme.theme_title')}
          content={(
            <SegmentedControls
        ...
        />
        <SettingTile
          title={t('Organisms.Settings.twitter_emoji.title')}
          options={(
            <Toggle
          ...
          content={<Text variant="b3">{t('Organisms.Settings.twitter_emoji.description')}</Text>}
        />
      </div>
      <div className="settings-appearance__card">
        <MenuHeader>{t('Organisms.Settings.room_messages.title')}</MenuHeader>
        <SettingTile
          title={t('Organisms.Settings.room_messages.layout')}
          content={
            <SegmentedControls
            selected={messageLayout}
            segments={[
              { text: t('Organisms.Settings.room_messages.modern') },
              { text: t('Organisms.Settings.room_messages.compact') },
              { text: t('Organisms.Settings.room_messages.bubble') },
            ]}
        ...
        />
        <SettingTile
          title={t('Organisms.Settings.message_spacing.title')}
          content={
            <SegmentedControls
            selected={spacings.findIndex((s) => s === messageSpacing)}
            segments={[
              { text: t('Organisms.Settings.message_spacing.no') },
              { text: t('Organisms.Settings.message_spacing.xxs') },
              { text: t('Organisms.Settings.message_spacing.xs') },
              { text: t('Organisms.Settings.message_spacing.s') },
              { text: t('Organisms.Settings.message_spacing.m') },
              { text: t('Organisms.Settings.message_spacing.l') },
            ]}
            onSelect={(index) => {
        ...
        />
        <SettingTile
          title={t('Organisms.Settings.newline.title')}
          options={(
            <Toggle
          ...
          content={<Text variant="b3">{t('Organisms.Settings.newline.description', { key: isMacOS() ? KeySymbol.Command : 'Strg'})}</Text>}
        />
        <SettingTile
        ...
        />
        <SettingTile
          title={t('Organisms.Settings.media_autoload.title')}
          options={(
            <Toggle
          ...
          content={<Text variant="b3">{t('Organisms.Settings.media_autoload.description')}</Text>}
        />
        <SettingTile
          title={t('Organisms.Settings.url_preview.title')}
          options={(
            <Toggle
              isActive={urlPreview}
          ...
          content={<Text variant="b3">{t('Organisms.Settings.url_preview.description')}</Text>}
        />
        <SettingTile
          title={t('Organisms.Settings.url_preview_encrypted.title')}
          options={(
            <Toggle
          ...
          content={<Text variant="b3">{t('Organisms.Settings.url_preview_encrypted.description')}</Text>}
        />
        <SettingTile
          title={t('Organisms.Settings.show_hidden.title')}
          options={(
            <Toggle
          ...
          content={<Text variant="b3">{t('Organisms.Settings.show_hidden.description')}</Text>}
        />
      </div>
    </div>
  );
...
function NotificationsSection() {
  ...
  const renderOptions = () => {
    ...
    return (
      ...
      >
        {t('Organisms.Settings.notifications_and_sound.request_permission')}
      </Button>
    );
  };
...
function AboutSection() {
  ...
  return (
    <div className="settings-about">
      <div className="settings-about__card">
        ...
        <div className="settings-about__branding">
          ...
          <div>
            ...
            <Text>{t('Organisms.Welcome.subheading')}</Text>
      ...
      <div className="settings-about__card">
        <MenuHeader>{t('Organisms.Settings.about.credits.title')}</MenuHeader>
        <div className="settings-about__credits">
          <ul>
            <li>
              ...
              <Text>
                <Trans
                  i18nKey="Organisms.Settings.about.credits.matrix_js_sdk"
                  components={{ a: <a /> }}
                />
              </Text>
            </li>
            <li>
              ...
              <Text>
                <Trans
                  i18nKey="Organisms.Settings.about.credits.twemoji_colr"
                  components={{ a: <a /> }}
                />
              </Text>
            </li>
            <li>
              ...
              <Text>
                <Trans
                  i18nKey="Organisms.Settings.about.credits.twemoji"
                  components={{ a: <a /> }}
                />
              </Text>
            </li>
            <li>
              ...
              <Text>
                <Trans
                  i18nKey="Organisms.Settings.about.credits.material_sound"
                  components={{ a: <a /> }}
                />
              </Text>
            </li>
